...
> For your first time using KBForge. Read this, then delete it from your vault.
...
!!! note "PowerShell security"
    If you get a security error, run this command in PowerShell first:
    ```powershell
...
Just open the folder. It's plain Markdown — no special setup needed.
...
Full walkthrough: [Setup Guide](setup.md)
